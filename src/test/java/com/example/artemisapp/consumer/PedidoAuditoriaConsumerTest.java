...
class PedidoAuditoriaConsumerTest {

    private final ObjectMapper objectMapper = mock(ObjectMapper.class);
    private final PedidoAuditoriaConsumer pedidoAuditoriaConsumer = new PedidoAuditoriaConsumer(objectMapper);

    @Test
    void deveDesserializarMensagemRecebidaParaSimularAuditoria() throws Exception {
        ...
        pedidoAuditoriaConsumer.consumir(mensagem);
